import { noman_whatsapp,noman_linkdin, noman_email} from "@/utility/data";
          ...
          <div className="row">
            ...
            <div className="col-lg-6 text-lg-end">
              <ul className="footer-bottom-nav">
                <li>
                  <a href={noman_whatsapp} target="_blank">Whatsapp</a>
                </li>
              
              
                <li>
                  <a href={noman_linkdin} target="_blank">LinkedIn</a>
                </li>   <li>
                  <a href="mailto:nomansanaullah6677@gmail.com"  >Email</a>
                </li>
              </ul>
            </div>
          </div>
